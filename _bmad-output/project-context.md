...
- **Build output:** Single `index.html` at project root (copied from `dist/index.html`) - **DO NOT EDIT THIS FILE**
...
# Step 2: Script copies dist/index.html to project root
...
- Post-build copy: `dist/index.html` → `index.html` (root)
